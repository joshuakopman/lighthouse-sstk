...
ws.onmessage = function (ev) {
    ...
    for (var index in payload.globals.pageTypes) {
        ...
        document.querySelectorAll("." + currentPage + "URL").forEach(function (el) {
...
function showActiveTest(ID) {
    document.querySelectorAll('.textScores span').forEach(function (el) {
    ...
    document.querySelectorAll('.running').forEach(function (el) {
